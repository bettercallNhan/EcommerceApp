        ...
        >
            <TabsStack.Screen
                name='Home' component = {HomeScreen} options ={{
                    ...
                    tabBarIcon:({focused}) => focused ?(
                        <Entypo name='home' size={24} color="#0097a"/>
                    ) : (
            ...
            <TabsStack.Screen
                name='Cart' component={CartScreen} options={{
                    headerShown: false,
                    tabBarIcon:({focused}) => focused ?(
                        <AntDesign name ='shoppingcart' size={24} color="#0097a"/>
                    ) : (
            ...
            <TabsStack.Screen
                name='Payment' component={PaymentScreen} options={{
                    headerShown: false,
                    tabBarIcon:({focused}) => focused ?(
                        <Ionicons name ='copy' size={24} color="#0097a"/>
                    ) : (
            ...
            <TabsStack.Screen
                name='Profile' component={ProfileScreen} options={{
                    headerShown: false,
                    tabBarIcon:({focused}) => focused ?(
                        <Ionicons name ='person' size={24} color="#0097a"/>
                    ) : (
